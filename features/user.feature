Feature: User
    ...
    - A user with admin role can to add and edit a user
		...
		Scenario: Add a user
			...
			When I fill form for user with  username "new_user_1", password "Hum123", a confirme password "Hum123", email "emailNewUser1@gmail.com" and roles "ROLE_USER"
			And I press "Ajouter"
		...
		Scenario: Edit a user
			...
			When I fill form for edit user with username "new_user_edit", password "Hum123", a confirme password "Hum123", email "newemail@gmail.com" and roles "ROLE_USER"
